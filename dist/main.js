...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scoringboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scoringboard */ \"./src/scoringboard.js\");\n/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./task */ \"./src/task.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\n\r\nconst addForm = document.querySelector('form');\r\nconst nameValue = document.querySelector('#name');\r\nconst scoreValue = document.querySelector('#score');\r\nconst refresh = document.querySelector('button');\r\n\r\nconst scoringboard = new _scoringboard__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\r\nconst task = new _task__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\r\n\r\nlet gameId;\r\nconst startGame = () => {\r\n  scoringboard.startGame('API_Project').then((response) => response.result.split(' '))\r\n  .then((res) => {\r\n    [gameId] = [res[1]]\r\n  });\r\n};\r\n\r\nconst getScores = () => {\r\n  scoringboard.getScores(gameId).then((response) => task.addToTask(response.result));\r\n};\r\n\r\nconst postScore = () => {\r\n  scoringboard.postScore(gameId, nameValue.value, scoreValue.value);\r\n  task.cleanInputs();\r\n};\r\n\r\ndocument.addEventListener('DOMContentLoaded', startGame);\r\naddForm.addEventListener('submit', postScore);\r\nrefresh.addEventListener('click', getScores);\r\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
